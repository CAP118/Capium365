...
public class ClientPortal_ManageTab_Actions {
	...
	@FindBy(xpath = "//span[normalize-space()='Save & Send Invite to 365']/parent::button")
	...
	@FindBy(xpath="//button[@title='Go To 365']")
	private static WebElement GoTo365;
	...
	public void FillthemandatorydetailsinaddClientandsaveandexit()
		...
		String Companyname = Client[0] + "_" + System.currentTimeMillis();
		String Name = Client[1] + "_" + System.currentTimeMillis();
		String Email = "sporysuknf" + "_" + System.currentTimeMillis() + "@gmail.com";
		HelperClass.safeType(EnterCompanyName, Companyname, "Company Name");
		HelperClass.safeType(EnterName, Name, "Name");
		HelperClass.safeType(EnterEmail, Email, "Email");
	...
	public void ValidateSuccessMessage() {
		...
		String ActualSuccessMessage = HelperClass.getText(By.xpath("//app-custom-notifications/div/p")).trim();
	...
	public void ClickonSaveandSendInviteTo365() throws Throwable {
		HelperClass.safeClick(SaveandsendInviteto365, "Save and Send Invite to 365");
		HelperClass.safeClick(ClickonYesProceedandInvite, "Proceed Invite");
	}
	...
	public void validateSearchandNaviagteto365() throws Throwable {
		HelperClass.safeType(SearchBar, "Bank_Rule_By_LImited_Client", "Search");
		HelperClass.hoverOverElement(By.xpath("//table[@aria-describedby='Invited to 365 list Table']/tbody/tr[1]"));
		HelperClass.safeClick(GoTo365, "Go To 365");
	}

	public void Validate365DashBoardMainGrid() {
		wait.until(
				ExpectedConditions.visibilityOfElementLocated(By.xpath("(//span[normalize-space()='Invoices'])[2]")));
		String Actual365DashBoard = HelperClass.getText(By.xpath("(//span[normalize-space()='Invoices'])[2]"));
	...
	public void ValidateEditDetailsPage() {
		String ActualEditDetailsPage = HelperClass.getText(By.xpath("(//span[normalize-space()='Details'])[2]"));
	...
	public void ClickonMoreVertOptions() throws Throwable {
		...
		// Thread .sleep(10000);
		// HelperClass.mouseHoverAndPerformActionnClientPortal("Invited to 365 list
		// Table",0, "more_vert");
	}
	...
	public void SelectStatusDropdownandVerify() throws Throwable {
		...
		HelperClass.verifyStatusTypes(HelperClass.getDriver(),
				"//table/tbody/tr/td[normalize-space()='Resend Invitation']", "Resend Invitation");
		Thread.sleep(2000);
		HelperClass.selectFromStatusDropdown(HelperClass.getDriver(),
	...
	public void ValidateStatusdrodown() throws Throwable {
		...
		Thread.sleep(2000);
		HelperClass.verifyStatusTypes(HelperClass.getDriver(),
				"//table/tbody/tr/td[normalize-space()='Invite']/following-sibling::td[1]", "Active");
		Thread.sleep(2000);
		HelperClass.selectFromStatusDropdown(HelperClass.getDriver(),
				"(//ng-select[normalize-space(@panelclass)='myPanelClass'])[2]", "Archived");
		Thread.sleep(2000);
		HelperClass.verifyStatusTypes(HelperClass.getDriver(),
				"//table/tbody/tr/td[normalize-space()='Invite']/following-sibling::td[1]", "Archived");
	}
	...
	public void ValidateConfirmArchivePopup() {
		String ActualConirmArchivepopup = HelperClass.getText(By.xpath("//h2[normalize-space()='Confirm Archive']"));
	...
	public void ValidateDeleteSuccessMessage() {
		String ActualDeleteSuccessMessage = HelperClass
				.getText(By.xpath("//p[normalize-space(text())='Record deleted successfully."));
